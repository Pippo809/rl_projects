...
class RL_Trainer(object):
    ...
    def collect_training_trajectories(self, itr, initial_expertdata, collect_policy, num_transitions_to_sample, save_expert_data_to_disk=False):
        ...
        :param num_transitions_to_sample:  the number of transitions we collect (batch size)
        :return:
        ...
        paths, envsteps_this_batch = utils.sample_trajectories(self.env, collect_policy, num_transitions_to_sample, self.params['ep_len'], False)
